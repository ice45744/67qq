...
export default function Home() {
  ...
  return (
    <div className="flex h-full w-full pb-[62px] md:pb-0">
      ...
      <div className="md:hidden fixed bottom-[62px] left-0 right-0 p-3 z-40">
        <button
          style={{ touchAction: "manipulation" }}
        ...
        {isMobileCartOpen && (
          <>
            ...
            <motion.div
              ...
              style={{ bottom: 62, height: "calc(90svh - 62px)" }}
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
              exit={{ y: "100%" }}
